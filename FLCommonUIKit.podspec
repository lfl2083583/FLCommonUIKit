...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of FLCommonUIKit.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/frank/FLCommonUIKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'frank' => '1966445096@qq.com' }
  s.source           = { :git => 'https://github.com/frank/FLCommonUIKit.git', :tag => s.version.to_s }
